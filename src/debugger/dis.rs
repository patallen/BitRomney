...
pub struct Disassembly {instructions: BTreeMap<u16, Inst>}
impl Disassembly {
    pub fn print(&self) {
...
impl fmt::Debug for Inst {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        match self.values.len() {
            ...
            1 => write!(f, "{:04X} | {:02X}        {}", self.loc, self.values[0], dissed),
            2 => write!(f, "{:04X} | {:02X} {:02X}     {}", self.loc, self.values[0], self.values[1], dissed),
